...
export const crises = [
    ...
    options: [
      {
        ...
        explanation: "A pious word costs nothing, so a pious word convinces nobody. Stone is different. When you empty a tenth of the treasury into a mosque the whole city can watch rising, you do a thing no impostor would do, because no impostor would pay so much merely to look devout. This is costly signalling, and stone is its cleanest form. That expense is the whole point: it is precisely why the gesture is believed.\n\nThe clergy's *fatwa* was built to say you neglect the faith. Answer it not with a speech but with masons and money, and the charge curdles in their mouths before the noon prayer. Expensive, yes. But the cheap defences are the ones nobody ever trusts.",
      },
      {
  ...
  },
  {
    ...
    concept: "Risk & safety trade-offs",
    ...
    options: [
      {
        ...
        explanation: "Mobilisation costs are what you are really weighing here: an army takes a generation to raise and a season to buy, and you have neither generation nor season. The Qipchaq lances wintering near Darband, the Gilani crossbowmen, the loose companies that drift down from the Ilkhan's broken musters — these men exist already, drilled and blooded, and they will ride for you within the month. You are not making soldiers. You are renting them, and renting is the cheapest way to mobilise that still leaves a bill.\n\nWhat you cannot pay in silver you will pay in promises, and a promise of silver is a debt with a sword standing over it. The Genoese factor who fronts their wages owns a lien on next year's customs before next year arrives, and the captains read your treasury better than your own steward does. So long as the coin flows they are the finest wall on the frontier. Let one pay-train run late in the mountain passes and that same wall turns inward, billets itself on the towns it was hired to shield, and sells its loyalty to whoever counts faster.\n\nTahmina would put it plainly: you have not closed the gap in the garrison, you have moved it onto the ledger, where it draws interest. The men are real. The bill comes due in spring, and it does not negotiate.",
      },
      {
        label: "Conscript the peasantry into a levy.",
        effects: { treasury: -2, people: -8, military: 8 },
        explanation: "Ring the village bells and you will have a thousand spears by the new moon, for every man between plow and grave becomes a soldier whether he consents or not. That is the easy half of the bargain: the bodies are cheap, and they come at once. The other half hides in the calendar. You are pulling these men off the land at sowing, so the levy that holds the pass this spring will starve the valley by autumn — that is the true face of mobilisation costs, not the spears but the season they cost you. They will man the wall while their fields go to weed, and they will not forget whose order emptied their houses. You are buying time against the harvest, and the harvest always collects.",
      },
    ],
